...
public class TeacherStuffMain {
    ...
    static boolean initialize() {
            System.out.println("A new day! Run program?");
            System.out.println();
            boolean runProgram = TextIO.getBoolean();

            if (runProgram) return runProgram;

            if (!runProgram) {
                System.out.println("This will close the program and restart the semester. Continue?");
                boolean yesImSure = TextIO.getBoolean();
                if (yesImSure) return runProgram;
                else if (!yesImSure) initialize();
            }
            return false;
    }
